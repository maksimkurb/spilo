...
postgresql:
  ...
  parameters:
    ...
    shared_preload_libraries: 'bg_mon,pg_stat_statements,pgextwlist,pg_auth_mon,set_user{{#USE_PGVECTO_RS}},vectors{{/USE_PGVECTO_RS}}{{#USE_VECTORCHORD}},vchord{{/USE_VECTORCHORD}}'
...
def get_placeholders(provider):
    ...
    placeholders.setdefault('USE_VECTORCHORD', False)
